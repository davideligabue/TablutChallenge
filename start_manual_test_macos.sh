...
osascript -e "tell application \"Terminal\" to do script \"cd $PLAYER_PATH && python3 PLAYER.py WHITE 60 127.0.0.1 search flag-3\""

# Open terminal tab for client BLACK
osascript -e "tell application \"Terminal\" to do script \"cd $PLAYER_PATH && python3 PLAYER.py BLACK 60 127.0.0.1 search grey\""
