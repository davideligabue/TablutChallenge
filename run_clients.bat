...
start "Client WHITE" cmd /k "cd /d %PLAYER_PATH% && python PLAYER.py WHITE 60 127.0.0.1 grey"

REM Apri una finestra per il client BLACK
echo Starting the BLACK client...
start "Client BLACK" cmd /k "cd /d %PLAYER_PATH% && python PLAYER.py BLACK 60 127.0.0.1 grey"
